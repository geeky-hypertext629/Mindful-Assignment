        ...
        <footer className="bg-zinc-900 py-12 px-4 text-base text-white sm:px-6 md:px-8 lg:py-16 lg:px-8 lg:pb-8">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="my-4 flex items-center gap-6">
                    <a
                        href="https://github.com/geeky-hypertext629"
                        target="_blank"
                    ...
                    <a
                        href="discordapp.com/users/steeleagle587"
                        target="_blank"
                        rel="noopener noreferrer nofollow"
                        className="text-gray-400 hover:text-gray-300"
                    >
                    ...
                    <a
                        href="https://www.linkedin.com/in/subhamchandra528/"
                        target="_blank"
                        rel="noopener noreferrer nofollow"
                        className="text-gray-400 hover:text-gray-300"
                    >
                ...
                <div className="mt-12 border-t border-zinc-600 pt-8">
                    <p className="text-base text-zinc-400 xl:text-center">
                        &copy;{" "}
                        <a
                            href="https://geeky-hypertext629.github.io/Portfolio-Website/"
                            target="_blank"
